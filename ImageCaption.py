...
features = extract_features('C:\\Users\\Abhishek\\Downloads\\Flickr8k_Dataset\\Flicker8k_Dataset')
...
filename = 'C:\\Users\\Abhishek\\Downloads\\Flickr8k_text\\Flickr8k.token.txt'
...
save_descriptions(descriptions,'C:\\Users\\Abhishek\\Downloads\\Flickr8k_text\\description.txt')
...
train = 'C:\\Users\\Abhishek\\Downloads\\Flickr8k_text\\Flickr_8k.trainImages.txt'
train_image_ids = load_set_of_image_ids(train)
print('Training images found: ',len(train_image_ids))

# load training descriptions
train_descriptions = load_clean_descriptions('C:\\Users\\Abhishek\\Downloads\\Flickr8k_text\\description.txt',train_image_ids)
...
for i in range(epochs):
  ...
  model.save('C:\\Users\\Abhishek\\Downloads\\Flickr8k_Dataset\\model_'+str(i)+'.h5')
...
####################  load test data  ##########################
test = 'C:\\Users\\Abhishek\\Downloads\\Flickr8k_text\\Flickr_8k.trainImages.txt'
test_image_ids = load_set_of_image_ids(test)
print('Test images found: ',len(test_image_ids))

# load test descriptions
test_descriptions = load_clean_descriptions('C:\\Users\\Abhishek\\Downloads\\Flickr8k_text\\description.txt',test_image_ids)
...
#################################################################
filename = 'C:\\Users\\Abhishek\\Downloads\\Flickr8k_Dataset\\model_18.h5'
...
img_to_test = 'C:\\Users\\Abhishek\\OneDrive\\Pictures\\BALI PASS TREK.jpeg'
...
max_length = 34
# load the model
model = load_model('C:\\Users\\Abhishek\\Downloads\\Flickr8k_Dataset\\model_18.h5')
